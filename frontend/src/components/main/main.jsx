...
const Main = () => {
  ...
  const menCategoryAPI = "products?populate=*&filters[categorie][$eq]=men";
  const womenCategoryAPI = "products?populate=*&filters[categorie][$eq]=women";
              ...
              return (
                ...
                >
                  ...
                  <CardContent>
                    ...
                    {item.attributes.productDiscripcion}
                  ...
                  <CardActions sx={{ justifyContent: "space-between" }}>
                    ...
                    <Rating
                      precision={0.1}
                      name="read-only"
                      value={item.attributes.productReting}
                      readOnly
                    />
                  </CardActions>
                </Card>
